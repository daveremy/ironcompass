...
- **Workouts**: Map to types: pickleball, strength, hike, golf, run, elliptical, mobility, sauna, hot_tub, indoor_cycle, other. Extract duration, distance, elevation, calories, HR from what's stated. Default source to "manual" for conversational logging. Include start_time/end_time (ISO 8601) if the user specifies when the workout occurred.
